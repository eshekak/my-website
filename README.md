...
* [`src/clj/my_website/`](src/clj/my_website/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/my_website/`](src/cljs/my_website/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/my_website/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/my_website/`](test/cljs/my_website/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `my-website` project root directory
...
in the [`src/clj/my_website/`](src/clj/my_website/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/my_website/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns my-website.example
  (:require [my-website.config :as config])
